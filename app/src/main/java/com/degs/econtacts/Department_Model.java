...
public class Department_Model {
    int id,rank;
    String name_eng,name_hi,short_name_eng,short_name_hi;

    public Department_Model(int id, int rank, String name_eng, String name_hi, String short_name_eng, String short_name_hi) {
        this.id = id;
        this.rank = rank;
