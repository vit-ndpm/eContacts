...
public class Officer_Model {
    ...
    public Officer_Model(int id, int rank, int assembly_id, int tehsil_id, int sub_division_id, int local_body_id, int department_id, int post_id, int role_id, int posting_level_id, String name_eng, String name_hi, String mobile, String email, String landline) {
        this.id = id;
        this.rank = rank;
    ...
    public Officer_Model(int id, int rank, String name_eng, String name_hi, String mobile, String email) {
        this.id = id;
        this.rank = rank;
        this.name_eng = name_eng;
        this.name_hi = name_hi;
