...
public class Sst_Model {
    int id,assembly_id;
    String name_eng,name_hi,shift,assembly_name_eng,assebly_name_hi;
    ArrayList<Officer_Model> sstOfficersList;

    public Sst_Model(int id, int assembly_id, String name_eng, String name_hi, String shift, String assembly_name_eng, String assebly_name_hi, ArrayList<Officer_Model> sstOfficersList) {
        this.id = id;
        ...
        this.sstOfficersList = sstOfficersList;
    }

    public Sst_Model(int id, int assembly_id, String name_eng, String name_hi, String shift, String assembly_name_eng, String assebly_name_hi) {
        this.id = id;
        this.assembly_id = assembly_id;
        this.name_eng = name_eng;
        this.name_hi = name_hi;
    ...
    public ArrayList<Officer_Model> getSstOfficersList() {
        return sstOfficersList;
    }

    public void setSstOfficersList(ArrayList<Officer_Model> sstOfficersList) {
        this.sstOfficersList = sstOfficersList;
    }
}
